module "aca_app" {
  ...
  # 네트워크 (선택)
  infrastructure_subnet_id       = "/subscriptions/bc08b927-9eba-423d-a61f-bc444d048ec9/resourceGroups/rg-jpe-stg-common/providers/Microsoft.Network/virtualNetworks/vnet-jpe-stg-common/subnets/snet-jpe-stg-pointail-aca"
