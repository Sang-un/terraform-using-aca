module "aca_app" {
  ...
  # 네트워크 (선택)
  infrastructure_subnet_id       = "/subscriptions/a98144a1-06aa-4136-9f70-d68d15be60f3/resourceGroups/rg-krc-stg-common/providers/Microsoft.Network/virtualNetworks/vnet-krc-stg-common/subnets/snet-krc-stg-stl-aca"
