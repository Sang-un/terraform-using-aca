module "aca_app" {
  ...
  # 네트워크 (선택)
  infrastructure_subnet_id       = "/subscriptions/d08e1c28-7a9a-4a3d-99ce-d74857edff01/resourceGroups/rg-jpe-prd-common/providers/Microsoft.Network/virtualNetworks/vnet-jpe-prd-common/subnets/snet-jpe-prd-pointail-aca"
